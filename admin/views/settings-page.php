	...
	<div class="ldap-ed-admin-layout">
		...
		<div class="ldap-ed-settings-col">
			<form method="post" action="options.php">
				...
				do_settings_sections( 'ldap-staff-directory' );
				submit_button();
				?>
			</form>
		</div>
		...
		<div class="ldap-ed-sidebar-col">
			...
			<div class="ldap-ed-card ldap-ed-card--connection">
				<h2><?php esc_html_e( 'Test Connection', 'ldap-staff-directory' ); ?></h2>
				<p><?php esc_html_e( 'Verify that WordPress can reach the LDAP server with the current settings.', 'ldap-staff-directory' ); ?></p>
				<button type="button" id="ldap-ed-test-btn" class="button button-primary">
					<?php esc_html_e( 'Test Connection', 'ldap-staff-directory' ); ?>
				</button>
			...
			<div class="ldap-ed-card ldap-ed-card--cache">
				<h2><?php esc_html_e( 'Cache', 'ldap-staff-directory' ); ?></h2>
				<p><?php esc_html_e( 'User data is cached to reduce LDAP queries. Click below to force a refresh.', 'ldap-staff-directory' ); ?></p>
			...
			<div class="ldap-ed-card ldap-ed-card--usage">
				<h2><?php esc_html_e( 'Usage', 'ldap-staff-directory' ); ?></h2>
				<p><?php esc_html_e( 'Insert this shortcode in any post or page:', 'ldap-staff-directory' ); ?></p>
				<code>[ldap_directory]</code>
				<p class="ldap-ed-card__label"><?php esc_html_e( 'With custom attributes:', 'ldap-staff-directory' ); ?></p>
